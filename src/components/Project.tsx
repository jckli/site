                        ...
                        <div className="mt-4 flex items-center gap-3">
                            {props.button_text && props.button_link && (
                                <motion.a
                                    ...
                                    rel="noreferrer"
                                    className="
                                    inline-flex items-center px-3 py-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-md text-text-color bg-[#2e3440] hover:bg-[#424a54] transition-all ease-in-out duration-200
                                "
                                    whileTap={{ scale: 0.95 }}
                                >
                            ...
                            <motion.a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="text-2xl text-text-color transition-all ease-in-out duration-200 hover:text-white/70 hover:cursor-pointer"
                                whileTap={{ scale: 0.95 }}
                            >
