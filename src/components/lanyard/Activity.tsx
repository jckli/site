                        ...
                        <div className="px-5 py-4">
                            <div className="flex flex-col text-text-color gap-3">
                                {data.listening_to_spotify && data.activities[0].type === 2 && (
                                    <>
                                        <h1 className="font-metropolis-bold text-text-lighter">
                                        ...
                                        <div className="flex flex-row">
                                            ...
                                            />
                                            <div className="flex flex-col ml-4 min-w-[150px] sm:min-w-[190px]">
                                ...
                                {data.activities[0].type === 0 && (
                                    <>
                                        <h1 className="font-metropolis-bold text-text-lighter">Playing Something</h1>
                                        <div className="flex flex-row">
                                            ...
                                            <div className="flex flex-col justify-center md:justify-start ml-4 min-w-[150px] sm:min-w-[190px]">
